...
class User extends React.Component {
    ...
    sortUsers = event => {
        if (event.currentTarget.attributes.getNamedItem("data-value").value === "name") {
            this.setState({
                ...
                <table className="table">
                    <thead>
                        <tr>
                            ...
                            <th className="text-center hover" scope="col" data-value="name" onClick={this.sortUsers}>Name</th>
                            <th className="text-center" scope="col">Email Address</th>
                            <th className="text-center" scope="col">Phone Number</th>
                            <th className="text-center hover" scope="col" data-value="state" onClick={this.sortUsers}>Location</th>
                        </tr>
                    </thead>
                    <tbody>
